...
<body>
  <div class="header">
    ...
    <button type="button" class="primary-button icon-label" onclick="openPopup(popups[0].formInitialized, popup, popupContainer)">
  ...
  <div class="popup-wrapper">
    <div class="popup-container">
      ...
      <div class="flex button-container">
        <button type="button" class="secondary-button" onclick="closePopup(popup, popupContainer, formContainer)">
          Cancel
        </button>
  ...
  <div class="popup-edit-wrapper">
    <div class="popup-edit-container">
      ...
      <div class="flex button-container">
        <button type="button" class="secondary-button" onclick="closeEditPopup()">
          Cancel
        </button>
